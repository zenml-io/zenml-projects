...
Examples:
  ...
  python run_pipelines.py --predict

  \b
  # Run both training and inference
  python run_pipelines.py --train --predict

  \b
  # Run with custom parameters
  python run_pipelines.py --train --forecast-horizon 28 --epochs 20 --batch-size 128 --hidden-size 128
"""
)
@click.option(
    "--train",
