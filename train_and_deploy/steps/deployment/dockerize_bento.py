...
def dockerize_bento_model(
    ...
    version_to_deploy = Model(name=model.name, version=target_env)
    bentoml_deployment = version_to_deploy.get_model_artifact(name="bentoml_deployment")
