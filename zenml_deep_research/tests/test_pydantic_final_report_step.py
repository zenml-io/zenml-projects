...
def sample_research_state() -> ResearchState:
    ...
    viewpoint_analysis = ViewpointAnalysis(
        main_points_of_agreement=["Climate change is happening", "Action is needed"],
        areas_of_tension=[
            ViewpointTension(
    ...
    reflection_metadata = ReflectionMetadata(
        ...
        additional_questions_identified=["How will climate change affect different regions?"],
        searches_performed=["economic impacts of climate change", "regional climate impacts"],
        improvements_made=2,
    )
