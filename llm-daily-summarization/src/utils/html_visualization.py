...
class HTMLVisualizer:
    ...
    def generate_pipeline_dashboard(
        ...
        stats = self._calculate_stats(processed_data, raw_conversations, cleaned_data)
    ...
    def _generate_header(self, timestamp: str, run_metadata: Optional[Dict[str, Any]]) -> str:
    ...
    def _generate_summaries_section(self, summaries: List[Summary]) -> str:
        ...
        for i, summary in enumerate(summaries):
            confidence_class = self._get_confidence_class(summary.confidence_score)
            summaries_html += f"""
    ...
    def _generate_conversations_section(self, cleaned_data: List[CleanedConversationData]) -> str:
    ...
    def _generate_prompts_section(self, agent_prompts: Optional[Dict[str, str]]) -> str:
    ...
    def _generate_metrics_section(self, evaluation_metrics: Optional[Dict[str, Any]]) -> str:
