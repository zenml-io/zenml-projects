            ...
            if kind == "Deployment":
                ...
                try:
                    ...
                    k8s_apps_v1.patch_namespaced_deployment(
                        name=name, namespace=namespace, body=k8s_config
                    )
                    ...
                    if e.status == 404:
                        ...
                        k8s_apps_v1.create_namespaced_deployment(
                            namespace=namespace, body=k8s_config
                        )
...
def k8s_deployment(docker_image_tag: str, namespace: str = "default") -> Dict:
    ...
    for config in k8s_configs:
        ...
        if config["kind"] == "Service":
            ...
            config["spec"]["template"]["metadata"]["labels"]["app"] = (
                model_name
            )
    ...
    try:
        ...
        logger.info(
            f"Successfully deployed model {model_name} with image: {docker_image_tag}"
        )
