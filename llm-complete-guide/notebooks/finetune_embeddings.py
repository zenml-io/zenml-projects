...
for i in range(n_examples):
  ...
  train_examples.append(InputExample(texts=[example['generated_questions'][0], example['page_content']]))
...
for i in range(n_test_examples):
  example = test_data[i]
  test_examples.append(InputExample(texts=[example['generated_questions'][0], example['page_content']]))
