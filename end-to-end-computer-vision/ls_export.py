...
ls = Client(url=LABEL_STUDIO_URL, api_key="78afe31bd58c157723501a0351e3716e9c52a714")
ls.check_connection()
...
project.export_tasks(export_type="YOLO", export_location="/tmp/whatever.zip", download_resources=True)
