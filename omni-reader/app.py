...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        if comparison_mode == "Single Model":
            ...
            # Get previously selected models if available
            ...
            # Ensure at least 1 model is selected - if none selected, use default
            ...
            # Store selected display names for persistence
...
def display_provider_info():
    ...
    provider_names = {"ollama": "Ollama", "openai": "OpenAI", "mistralai": "MistralAI"}
        ...
        for i, model_id in enumerate(model_ids):
            ...
            with column:
                with st.spinner(f"Processing with {model_name}..."):
                    ...
                    display_result(model_name, result, proc_time, model_id, model_logos)
