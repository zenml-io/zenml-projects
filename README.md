...
-| [LLMOps Article Classifier](llmops-article-classifier) | `LLMOps` `Article Classification` `Fine-tuning` `Model Evaluation` `Model Comparison` | `anthropic` `huggingface` `pytorch` `transformers` `docker` |
